...
```
The linreg function is approximately 7 times more efficient than lm at parameter estimation and inference. The tradeoff is that linreg does not provide additional model information, such as F-statistic. 
```{r, fig.dim = c(6, 3)}
set.seed(625)
